...
export class EmailService {
  ...
  async sendBookingConfirmation(booking: BookingWithRelations, calendarEvent: CalendarEventResponse) {
    ...
    const invoicePDF = await generateInvoicePDF({
      ...
      isBusinessCustomer: false, // This should come from booking data
